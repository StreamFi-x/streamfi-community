...
export default function PeopleLikeYou() {
  return (
    <div className=" bg-[#111111] border border-white text-white p-4 rounded-lg max-w-[450px] w-full">
      <div className="w-full bg-[#121212] px-4 h-16 flex items-center justify-start">
